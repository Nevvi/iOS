...
//  Nevvi
//
//  Created by Tyler Cobb on 1/26/23.
//
...
struct ColorConstants {
    static var primary: Color {
        return Color(UIColor(hexString: "#0098ff"))
    }
    
    static var secondary: Color {
        return Color(UIColor(hexString: "#162d50"))
    }
    ...
    static var text: Color {
        return Color(UIColor(hexString: "#1c1616"))
    }
...
/**
 static var primary: Color {
     return Color(UIColor(hexString: "#dfb995"))
 }
 
 static var secondary: Color {
     return Color(UIColor(hexString: "#8e5b3d"))
 }
 
 static var tertiary: Color {
     return Color(UIColor(hexString: "#4d2c26"))
 }
 ...
 static var accent: Color {
     return Color(UIColor(hexString: "#f1e8dc"))
 }
 */
